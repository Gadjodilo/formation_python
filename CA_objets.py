...
#	prenom=raw_input("Prenom")
	...
	contact1=Contact("Richard","Johann")
	contact2=Contact("Lerouzic","Bertrand")
	contact3=Contact("Gendrot","Fabrice")
	contact4=Contact("Gendrot","Frederic")
	contact5=Contact("Gentric","Pascal")
